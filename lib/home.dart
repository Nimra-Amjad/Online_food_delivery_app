...
import 'package:online_food_app/foodDetail.dart';
...
class _HomePageState extends State<HomePage> {
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) => Padding(
                      ...
                      child: foodCategoryCard(
                          foodCategoryList[index]['imagePath'].toString(),
                          foodCategoryList[index]['name'].toString(),
                          index),
                    ),
                  ),
                ),
                ...
                Column(
                  children: List.generate(
                    ...
                    (index) => popularFoodCard(
                      popularFoodList[index]['imagePath'].toString(),
                      popularFoodList[index]['name'].toString(),
                      popularFoodList[index]['weight'].toString(),
                      popularFoodList[index]['star'].toString(),
                      popularFoodList[index]['price'].toString(),
                    ),
                  ),
                ),
              ],
  ...
  Widget popularFoodCard(
      String imagePath, String name, String weight, String star, String price) {
